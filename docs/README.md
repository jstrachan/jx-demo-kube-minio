...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
	      ...
	      <td>1.6.6</td>
	      <td><a href='http://dashboard-jx.35.234.147.113.nip.io'>view</a></td>
    ...
    <tr>
		      <td colspan='4'><h3>minio</h3></td>
		    </tr>
	    <tr>
	      <td><a href='https://min.io' title='A Helm chart for MinIO Operator'> <img src='https://min.io/resources/img/logo/MINIO_wordmark.png' width='24px' height='24px'> minio-operator </a></td>
	      <td></td>
	      <td></td>
